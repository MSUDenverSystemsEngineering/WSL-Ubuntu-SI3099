...
Try {
    ...
    [string]$appVendor = 'Windows'
    [string]$appName = 'Windows Subsystem for Linux'
    [string]$appVersion = 'Ubuntu'
    [string]$appArch = ''
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '08/17/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path 'C:\Windows\System32\Dism.exe' -Parameters "/online /enable-feature /featurename:Microsoft-Windows-Subsystem-Linux /all /norestart"
        ...
        Copy-File -Path "$dirFiles\chemubuntu" -Destination "C:\" -Recurse
        Copy-File -Path "$dirFiles\chemistrylabsubuntu.bat" -Destination "C:\Users\Public\Desktop\"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDY1x7SBeAUaces
# CRj4GXzp9+V+N7EMWLQPR737yeTmF6CCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDX8u4x6Nv1maZS
# BM/5JLpMKo3R5u3LpPe0ffpWKqPwWjANBgkqhkiG9w0BAQEFAASCAYAnmuBNCoE4
# gMwtehu8vL6UQ+HLluGFy57EKO9LZ1CnW3NbfZJaOdw/KMAbmCxhhwqMxkEP8mVo
# PoQmPXIBLu2Cy8mWQCcWrA2CK9jk3nnDhKjT8S67G9mu6LDznpSKgRZJduUbbLQR
# m650ZEn8cf5FJF9fMUAONN9Quf3/tz942yUuvmVk2mb81HUH1286VONFeDSll6OR
# Zf2Wsuor0Uai6fx/ZkMlE55GixytyxpF9YeFZ/FlW9ZwAklFsCiZMNlnpJAZsriN
# Y/im2vYykqbofuaNAsHwp+RxfLzuMuyFKkfrQ0GXONvas2YnLBy+TYK+5Mh6UqRu
# BJeTlQ07Gc7TP/1h/ZfeYl/Z+ANLSGlErrg64+Kpks7RTS2q5r00AcZ1vERgBFU6
# kecA9pFU+36RTJ/on3PF8Soe84YREVR4vp+TreHn1N/FUreHT/b/ejTxHeglP39L
# LYD7V0eTrEkwtM/v7ZgDoV7umTInV8qFCEobKKY2Sl+0vpQB1vcfJ06hggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwODE3MTky
# MDE0WjA/BgkqhkiG9w0BCQQxMgQwhV6I/X6o+QIDbcIBa5Sf5uVqRl9dXGm5etVC
# SebyjWk6t7omhgFf4DskrggFEUG9MA0GCSqGSIb3DQEBAQUABIICAIcCfXrxSgfF
# dS3uqtYeYb//bB06UORzmxfwG5G+aN3GzgTauckuQ7cNSpMsi45M7jcebpgQVRjO
# mvv3S0s58hPeXEj7Zzt+zE/VImBCalG2zFPspiDQJQtyyAWPDTSiXd63EMmFT4yy
# s4FAVnV3tnRwgKOhhuPwZ2PjxJgQasSrcAu1KRuIX5UphjTE2JOH+Xjt91DYl+H+
# +GUHU5iM5jlw1Gcgy2WJzwUy2BHaTbjR3E5I8ohh7hrxYqU5A7L/PZn0K4X8uphg
# EdJ762a+Qs8g5KH7xQ08T42d3Uk994NtU39f8kKB+UNIWMrp/6WBEx99ih9YGq5S
# tL1q4LJIW2cp9ZRaZ9+uqBhnG7P4dBU++iiEJptPqSp9BX4lgbsLRv5Pn9RvDcwU
# EkbIYPHtIjsNNbIr7C0BJjQRft3TAVLLmoKS7jwT2Kq46k6llCmUkWPWe31pApC6
# GPRL1Xwu5RB2O61g5lRVDfp+c9+juiMF9aF3wJlSh9ycBDqQuOAY2okQrBORGuyX
# DgOLBxZYYlPbgcOancjPfHIQBljczxYBxSdQkiniiqmXlde48GIyw/679Rgh2+Q+
# ZJnl8BGqoTZ/6zy3hgE9VEa7UHu0S8RVBfBrJxSIWv9E7agmIO5Dy5f2toBZi9Lv
# +g1hgfvp4CPNRoQAusApdHM37m3yLloE
